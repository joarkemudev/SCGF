					...
					<div class="card-content">
						...
						<div class="form-body">
							...
							<div class="row">
								...
								<spring:bind path="membresia.cliente">
									<div class="col-md-4">
										<div class="form-group ${status.error ? 'has-error' : ''}">
											<label class="control-label">Socios *</label>
											<form:select path="cliente.id" multiple="false" class="select2-container form-control select2me">
												<form:option value="">Seleccione un socio</form:option>
												<form:options itemValue="id" itemLabel="nombreCompleto" items="${clientes}"/>
											</form:select>															
											<form:errors path="cliente.id" class="help-block"></form:errors>										
										</div>
									</div>
								</spring:bind>
									...
									<div class="col-md-3">
										<div class="form-group ${status.error ? 'has-error' : ''}">
											...
											<form:select path="plan.id" multiple="false" class="select2-container form-control select2me">
												<form:option value="">Seleccione un plan</form:option>
									...
									<div class="col-md-3">
		                                 <div class="form-group ${status.error ? 'has-error' : ''}">
		                                    ...
		                                    <div class="input-group input-medium date date-picker"
		                                         ...
		                                         <form:input path="fechaInicio" type="date" maxlength="10" required="true"
							...
							<div class="row">
								...
								<div class="col-md-3">
									...
									<div ><fmt:formatDate value="${membresia.fechaAlta}" pattern="yyyy/MM/dd HH:mm:ss"/> </div>
									</div>
								</div>
								...
								<div class="col-md-3">
									...
									<div><c:out value="${membresia.usuarioAlta}"/></div>
									</div>
								</div>
								...
								<div class="col-md-3">
									...
									<div ><fmt:formatDate value="${membresia.fechaModifica}" pattern="yyyy/MM/dd HH:mm:ss"/> </div>
									</div>
								</div>
								...
								<div class="col-md-3">
									...
									<div><c:out value="${membresia.usuarioModifica}"/></div>
									</div>
								</div>				
							</div>
							</c:if>
						...
						<form:hidden path="cliente.correoElectronico"/>
